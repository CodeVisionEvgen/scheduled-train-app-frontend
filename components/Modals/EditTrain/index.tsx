...
export const ModalEditTrain = ({
  ...
  async function updateTrainHandler(e: SubmitEvent<HTMLFormElement>) {
    e.preventDefault();
    ...
    try {
      setIsLoading(true);
      await api.patch(`/scheduled-train/${item!.id}`, {
        from,
        to,
        arrival,
        departure,
